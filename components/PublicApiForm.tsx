...
const PublicApiForm: React.FC<PublicApiFormProps> = ({ 
  onSuccess, 
  onCancel, 
  ...
  // Enviar formulário usando Supabase diretamente
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      console.log('Enviando solicitação para o Supabase');
      ...
      console.log('Solicitação inserida com sucesso no Supabase:', data);
